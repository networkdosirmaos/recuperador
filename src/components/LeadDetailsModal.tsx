                    ...
                    <tbody className="divide-y divide-gray-100">
                      {(() => {
                        ...
                        const mappings = [
                          ...
                          { jsonKey: 'reason (ou refusalReason)', dbKey: 'Motivo Falha (Recusa)', dbVal: lead.reason },
                          { jsonKey: 'refundReason (ou refund_reason)', dbKey: 'Motivo do Reembolso', dbVal: lead.refund_reason },
